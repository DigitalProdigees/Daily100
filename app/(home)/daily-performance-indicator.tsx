...
export default function DailyPerformanceIndicatorScreen() {
	const performanceMetrics = [
		{ id: 1, title: 'Calls: Outbound Prospecting', points: 1, total: 2 },
		{ id: 2, title: 'Calls; Prospect Follow-Up', points: 1, total: 2 },
		{ id: 3, title: 'Calls; Client Nuturing', points: 1, total: 2 },
		{ id: 4, title: 'Attend Professional Networking Event', points: 1, total: 2 },
		{ id: 5, title: 'Ask for Referral', points: 1, total: 2 },
		{ id: 6, title: 'Referral / Intro Received', points: 1, total: 2 },
		{ id: 7, title: 'Set Appointment: Strategic Partner', points: 1, total: 2 },
		{ id: 8, title: 'Set Appointment: Champion', points: 1, total: 2 },
	...
	return (
		<SafeAreaView style={styles.container}>
			...
			<View style={styles.titleContainer}>
				...
				<Text style={styles.title}>Indicator</Text>
			</View>
